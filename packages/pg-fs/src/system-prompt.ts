...
\`\`\`typescript
{
  ...
  file_path: string;
  // Encoding format for the file content (optional: "utf8" | "base64")
  encoding?: string;
}
\`\`\`
...
\`\`\`typescript
{
  ...
  content: string;
  // MIME type of the file (e.g., text/plain, application/json) (optional)
  mime_type?: string;
  // Create parent directories if they do not exist (optional, default: false)
...
\`\`\`typescript
{
  ...
  file_path: string;
  // The exact text to replace (must match the file contents exactly)
  old_string: string;
...
# ls
Lists files and directories in a given path. Returns names and metadata.

\`\`\`typescript
{
  // The absolute path to the directory to list
  path: string;
  // Return detailed file information (optional, default: false)
  detailed?: boolean;
}
\`\`\`
...
\`\`\`typescript
{
  ...
  path: string;
  // Delete directory and all its contents (optional, default: false)
  recursive?: boolean;
}
\`\`\`
...
\`\`\`typescript
{
  ...
  dest_path: string;
  // Copy directory and all its contents (optional, default: false)
  recursive?: boolean;
}
\`\`\`
...
\`\`\`typescript
{
  // The absolute path to get information about
  path: string;
}
\`\`\`
...
\`\`\`typescript
{
  // Glob pattern to match (e.g., *.txt, file?.md)
  pattern: string;
  // Base directory to search from (optional, default: "/")
  base_path?: string;
}
\`\`\`
...
export const systemPrompt = tone + tools